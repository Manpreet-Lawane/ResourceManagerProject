...
class RawData(models.Model):
    RecordNumber = models.IntegerField(primary_key=True)
...
class Hospitals(models.Model):
    HospitalID = models.CharField(primary_key=True,max_length=10, unique=True)
    HospitalName = models.CharField(max_length=255)
    Address = models.CharField(max_length=255)
    City = models.CharField(max_length=255)
    StateCode = models.CharField(max_length=2)
...
class HospitalExpenses(models.Model):
    RecordNumber = models.OneToOneField(RawData, on_delete=models.CASCADE, primary_key=True)
    ...
    def __str__(self):
        return f"{self.HospitalName} - {self.FiscalYearBegin}"

    class Meta:
        unique_together = (('HospitalID', 'FiscalYearBegin'),)
